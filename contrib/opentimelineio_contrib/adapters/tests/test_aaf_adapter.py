...
class AAFReaderTests(unittest.TestCase):
    ...
    def test_aaf_clip_with_timecode_offset(self):
        timeline = otio.adapters.read_from_file(TIMCODE_EXAMPLE_PATH, clip_timecode_offset=True)
    ...
    def test_aaf_clip_without_timecode_offset(self):
        timeline = otio.adapters.read_from_file(TIMCODE_EXAMPLE_PATH, clip_timecode_offset=False)
        expected_start_times = {
            'Frame Debugger 0h.mov': 24.0,
